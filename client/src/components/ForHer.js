  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5050/recommend", config);
  ...
  return (
    <div className="u20MainParent fof">
      ...
      <div className="u20HeadingHold gap-20 justify-center relative flex flex-col">
        <p className="u20Heading">Your Recommendations </p>
        <p className="u20Desc">
          Shop for a collection of products specifically curated for you.
        </p>
      </div>
